...
var Utils = {
    ...
    mmssmm: function (e) {
      ...
      return (
        ...
        n < 10 && (n = "0" + n),
        r < 100 && (r = "0" + r),
        (a = (a = (a = a.replace(/MM/, n)).replace(/SS/, o)).replace(
          /XX/,
    ...
    readCookie: function (e) {
      for (
        ...
        for (var n = r[o]; " " == n.charAt(0); ) n = n.substring(1, n.length);
    ...
    isMobile: function () {
      return !(
        !/iPhone|iPad|iPod|Android/i.test(navigator.userAgent) && !pc.isMobile
      );
    },
    isIOS: function () {
      return [
...
Movement.attributes.add("defaultSpeed", {
  ...
  (Movement.prototype.onCollisionStart = function (t) {
    return (
      ...
      !pc.isFinished &&
      (t.other &&
        ("Bounce" == t.other.name && this.bounceJump(this.airTime, t.other),
      ...
      void (
        t.contacts[0].normal.y > 0.85 && ((this.isCollided = !0), this.land())
      ))
    );
  }),
  ...
  (Movement.prototype.onMouseMove = function (t) {
    return (
      ...
      (this.isMouseLocked &&
        ...
        this.isFocusing
          ? ((this.senseX -=
              t.movementX * this.focusLookSense * this.mouseInvertAxis),
            (this.senseY -=
              t.movementY * this.focusLookSense * this.mouseInvertAxis))
          : ((this.senseX -=
              t.movementX * this.defaultLookSense * this.mouseInvertAxis),
            (this.senseY -=
              t.movementY * this.defaultLookSense * this.mouseInvertAxis))),
    ...
    this.isFocusing
      ...
      this.isFocusing
        ? ((this.senseX -= t * this.focusLookSense * this.mouseInvertAxis),
          (this.senseY -= e * this.focusLookSense * this.mouseInvertAxis))
  ...
  (Movement.prototype.setKeyboard = function () {
    return (
      ...
      (this.jumpingTime + this.jumpLandTime < this.timestamp &&
        ...
        (this.isLeft = !1),
        (this.isRight = !1)),
      (this.app.keyboard.isPressed(pc.KEY_W) || this.isMobileForward) &&
        (this.isForward = !0),
      (this.app.keyboard.isPressed(pc.KEY_S) || this.isMobileBackward) &&
        (this.isBackward = !0),
      (this.app.keyboard.isPressed(pc.KEY_A) || this.isMobileLeft) &&
        (this.isLeft = !0),
      (this.app.keyboard.isPressed(pc.KEY_D) || this.isMobileRight) &&
        (this.isRight = !0),
  ...
  (Movement.prototype.setMovement = function () {
    ...
    this.isFocusing && (i = this.focusSpeedFactor),
      ...
      !this.isForward || this.isLeft || this.isRight
        ? this.isForward &&
          ((this.force.x += t.x * this.strafingSpeed * i),
          (this.force.z += t.z * this.strafingSpeed * i))
        : ((this.force.x += t.x * this.defaultSpeed * i),
          (this.force.z += t.z * this.defaultSpeed * i)),
      this.isBackward &&
        ((this.force.x -= t.x * this.strafingSpeed * i),
        (this.force.z -= t.z * this.strafingSpeed * i)),
      this.isLeft &&
        ((this.force.x -= e.x * this.strafingSpeed * i),
  ...
  (Movement.prototype.setMovementAnimation = function (t) {
    ...
    this.isFocusing && this.isReloading < this.timestamp
      ? ((o = this.focusPositionEntity),
        (a = 0.1),
    ...
    p = Math.min(p, 0.08);
    var m = 0.4;
    "Shotgun" == this.currentWeapon.type && (m = 0.8);
    var c = this.handEntity
      .getLocalPosition()
      .lerp(this.handEntity.getLocalPosition(), o.getLocalPosition(), m);
    ...
    this.now() - this.focusStartTime > 60
      ...
      this.movementHolder.setLocalPosition(
        ...
        (e + p) * a + this.animation.landAngle * a,
        0.2 * -s * a
      ),
    ...
    if (
      ...
      this.movementHolder.setLocalEulerAngles(
        ...
        this.animation.movementAngleY + e + s * this.movementAngleFactor * a,
        this.animation.movementAngleZ +
          this.directionSenseZ +
          this.animation.jumpAngle * a
      ),
      ...
      this.weaponCenter.setLocalEulerAngles(
        ...
        -e * e +
          0.1 * this.senseX +
          n +
          20 * this.animation.bounceX +
          this.animation.weaponAngleY,
      ...
      this.isFocusing && (l = 0.12),
        this.isLeft
          ? (this.directionSenseX = pc.math.lerp(
              this.directionSenseX,
              -25 * l,
              0.07
            ))
        ...
        this.isBackward &&
          (this.directionSenseZ = pc.math.lerp(this.directionSenseZ, 0.8, 0.1));
    }
    if (
      ...
      (this.cameraNonFOVEntity.camera.fov =
        this.currentNonFov + this.animation.fov),
      this.isForward ||
        this.isBackward ||
      ...
      this.now() - this.lastFootDate > this.footSpeed &&
        this.currentSpeed > 1 &&
        this.isLanded)
    ) {
      ...
      (this.entity.sound.slots[d].pitch = 1 + 0.1 * Math.random()),
        (this.entity.sound.slots[d].volume =
          0.2 + 0.2 * Math.random() + 0.3 * this.footForce),
    ...
    pc.isFinished ||
      ...
      "Sniper" == this.currentWeapon.type
        ? this.now() - this.focusStartTime > 60 &&
          ((this.cameraEntity.script.zoom.enabled = this.isFocusing),
          (this.currentWeapon.scopeOverlay.enabled = this.isFocusing))
        : this.isZoomEffectEnabled
        ? (this.cameraEntity.script.zoom.enabled = !0)
        : (this.cameraEntity.script.zoom.enabled = !1);
  }),
  (Movement.prototype.dash = function () {
    ...
    (this.isDashing = !0),
      ...
      this.axeEntity
        .tween(this.axeEntity.getLocalEulerAngles())
        .rotate(
          {
            x: 48.79,
            y: -44.81,
  ...
  (Movement.prototype.meleeSkill = function () {
    return (
      ...
      !this.isThrowing &&
        (this.cancelInspect(!0),
        void ("Lilium" == this.player.characterName
          ? this.melee()
          : "Shin" == this.player.characterName && this.dash())))
    );
  }),
  (Movement.prototype.meleeHit = function () {
    this.axeEntity.setLocalPosition(-1.341, -2.65, -3.462),
      this.axeEntity
        .tween(this.axeEntity.getLocalPosition())
        .to(
          {
            y: 0.67,
          },
      ...
      Math.random() > 0.5
        ? (this.axeEntity.setLocalEulerAngles(66.97, -17.07, 29.54),
          this.axeEntity
            .tween(this.axeEntity.getLocalEulerAngles())
            .rotate(
              {
            ...
            .delay(0.2)
            .start())
        : (this.axeEntity.setLocalEulerAngles(-42.45, -13.74, 21.08),
          this.axeEntity
            .tween(this.axeEntity.getLocalEulerAngles())
            .rotate(
              {
  ...
  (Movement.prototype.throw = function () {
    return this.now() - this.lastThrowDate < 1e3 * this.player.throwCooldown
      ...
      : !(this.isReloading > this.timestamp) &&
          ...
          this.stopFiring(),
          (this.isThrowing = !0),
          "Lilium" == this.player.characterName
            ? this.throwGrenadeAnimation()
            : "Shin" == this.player.characterName &&
  ...
  (Movement.prototype.impact = function () {
    ...
    this.app.fire("Character:Sound", e, 0.1 * Math.random()),
      (this.lastImpactTime = this.now());
  }),
    ...
    if (
      ...
      (this.dynamicGravity += t * this.gravityStep * this.gravityStep),
        ...
        this.entity.rigidbody.applyForce(
          0,
          this.gravity + this.gravity * e - this.dynamicGravity,
          0
        );
    } else
  ...
  (Movement.prototype.setCurrentValues = function (t) {
    this.isLanded
      ? (this.animation.jumpAngle = pc.math.lerp(
          this.animation.jumpAngle,
          0,
          0.2
        ))
      : (this.animation.jumpAngle = pc.math.lerp(
      ...
      (this.animation.landAngle = pc.math.lerp(
        this.animation.landAngle,
        0,
        0.1
      ));
    var e = 1;
    this.isLanded || (e = 0.1),
      (this.currentForce.x = pc.math.lerp(
        this.currentForce.x,
        this.force.x,
        e
      )),
      (this.currentForce.y = pc.math.lerp(
        this.currentForce.y,
        this.force.y,
        e
      )),
      (this.currentForce.z = pc.math.lerp(
        this.currentForce.z,
        this.force.z,
        e
      ));
  ...
  (Movement.prototype.setGravity = function () {
    var t = this.entity.getPosition().clone(),
      ...
      n = [];
    i &&
      ((n = i.entity.tags.list()),
      (s = i.point.sub(this.entity.getPosition().clone()).length()),
      n.indexOf("Wood") > -1 || n.indexOf("Concrete") > -1
    ...
    (this.lastHeight = o),
      ...
      this.currentHeight > this.collisionHeight
        ? (this.isLanded &&
            (this.lastVelocity = this.entity.rigidbody.linearVelocity.clone()),
          (this.isLanded = !1))
        : ((this.isLanded = !0),
  ...
  (Movement.prototype.setShooting = function (t) {
    ...
    if (
      ...
      this.cancelInspect(!0),
        ...
        ("Sniper" != this.currentWeapon.type &&
          ...
          this.isFocusing &&
            (this.spreadNumber = this.currentWeapon.focusSpread),
          (a = -5),
          (h = 5.2)),
      ...
      ("Sniper" == this.currentWeapon.type && this.isFocusing) ||
        (this.app.fire("EffectManager:Bullet", c, u),
      ...
      var l = this.currentWeapon.muzzlePoint.getPosition().clone(),
        ...
        y =
          Math.random() * this.spreadNumber - Math.random() * this.spreadNumber,
        g =
          Math.random() * this.spreadNumber - Math.random() * this.spreadNumber,
        v =
          Math.random() * this.spreadNumber - Math.random() * this.spreadNumber,
      ...
      (this.lookY += 0.04 * i),
        (this.spreadNumber = pc.math.lerp(this.spreadNumber, r, 0.4)),
        (this.spreadCount += t),
        ...
        this.app
          ...
          .to(
            {
              cameraShootBounce: a,
              cameraBounce: this.animation.cameraBounce + 0.025 * i,
            },
            0.09,
            pc.BackOut
          )
          .start(),
        (this.animation.activeBounce = pc.math.lerp(
          this.animation.activeBounce,
          -i,
          0.05
        )),
    ...
    this.isShooting < this.timestamp &&
      ...
      (this.animation.bounceAngle = pc.math.lerp(
        this.animation.bounceAngle,
        0,
        0.2
      )),
      (this.animation.shootSwing = pc.math.lerp(
        this.animation.shootSwing,
        0,
        0.01
      )),
      ...
      (this.animation.cameraShootBounce = pc.math.lerp(
        this.animation.cameraShootBounce,
        0,
        0.1
      )),
      (this.animation.cameraBounce = pc.math.lerp(
        this.animation.cameraBounce,
        0,
        0.1
      )),
      (this.animation.cameraImpact = pc.math.lerp(
        this.animation.cameraImpact,
        0,
        0.1
      )),
  ...
  (Movement.prototype.setShootDirection = function () {
    ...
    (this.raycastShootFrom = s), (this.raycastTo = n);
  }),
  (Movement.prototype.updateAutoLock = function () {
    if (this.lastAutoLockTime > this.timestamp) {
      ...
      var t = this.entity.getPosition(),
        e = Utils.lookAt(
          this.nearestPlayerPosition.x,
          this.nearestPlayerPosition.z,
          t.x,
          t.z
        );
    ...
    this.setShootDirection();
    var i = this.app.systems.rigidbody.raycastFirst(
      this.raycastShootFrom,
      this.raycastTo
    );
    i &&
      i.entity.tags &&
      i.entity.tags.list().indexOf("Player") > -1 &&
      "-1" != i.entity.script.enemy.playerId &&
      ((this.currentWeapon.spread = 0.1),
      (this.leftMouse = !0),
  ...
  (Movement.prototype.setAutoLock = function (t) {
    this.lastAutoLockTime < this.timestamp &&
      ((this.nearestPlayerPosition = t),
      (this.lastAutoLockTime = this.timestamp + 0.1));
  }),
  (Movement.prototype.scanShootables = function () {
    ...
    var t = this.entity.getPosition(),
      e = !1,
      i = 900,
      s = this.app.systems.rigidbody.raycastFirst(
        this.raycastShootFrom,
        this.raycastTo
      );
    if (s && s.entity.tags.list().indexOf("Player") > -1) {
      var n = s.entity.getPosition().sub(t).length();
      n < i && ((e = s.point), (i = n), this.app.fire("Touch:AutoLock", e));
    }
    e && this.app.fire("Touch:AutoLock", e), (this.lastScanUpdate = Date.now());
  }),
  (Movement.prototype.checkGlitches = function () {
    (this.entity.rigidbody.linearVelocity.length() > 300 ||
  ...
  ((function (t, e) {
    ...
    function D(t, o) {
        ...
        if (((M.length = 0), C.graph))
          for (
            ...
            (M[y] = C.graph.appendChild(
              ...
              (M[y].style.bottom = 0),
              (M[y].style.right =
                y * h.column.width + y * h.column.spacing + "px"),
      ...
      (O.options = F),
        ...
        (O.pause = function () {
          return (
            f && ((O.isPaused = 1), clearTimeout(f), a(f), a(x), (f = x = 0)), O
          );
        }),
        (O.resume = function () {
...
Overlay.attributes.add("focusBulletsEntity", {
  ...
  (Overlay.prototype.setPausePlayers = function (t) {
    ...
    for (var a in t) {
      ...
      (r.enabled = !0),
        ...
        n.verified &&
          ((r.findByName("Username").findByName("Verified").enabled = !0),
  ...
  (Overlay.prototype.onTeamChange = function (t) {
    ...
    (this.teamNotification.enabled = !0),
      ...
      (this.teamNotificationText.element.text =
        "Your team changed to " + t + "."),
  ...
  (Overlay.prototype.setWhiteShadow = function (t) {
    t
      ? (this.entity.sound.play("White-Shadow"),
        ...
        (this.holdAnimation = this.holdBarEntity
          .tween(this.holdBarEntity.getLocalScale())
          .to(
            {
              x: 1,
              y: 1,
    ...
    this.currentCards)) {
      ...
      0 === l ? (n = 3) : 2 === l && (n = -3),
        this.cardEntities[e].glow ||
          ((this.cardEntities[e].glow = this.cardEntities[e].findByName(
            "Glow"
          )),
          ...
          function (t, e) {
            (e.key.enabled = !0),
              ...
              e.glow
                ...
                .delay(0.3)
                .start(),
              (t.entity.sound.slots["Show-Card"].pitch =
                0.1 * Math.random() + 1),
  ...
  (Overlay.prototype.onWeaponChange = function (t) {
    ...
    for (var a in i) {
      var n = i[a];
      n.name == t
        ? (n.element.color = pc.colors.active)
        : (n.element.color = pc.colors.gray);
    }
    (this.weaponTimer = 8),
  ...
  (Overlay.prototype.weaponTimeoutSet = function () {
    (this.weaponTimeoutText.element.text =
      "Please wait " + this.weaponTimer + " seconds..."),
      this.weaponTimer--,
      this.weaponTimer > 0 &&
        setTimeout(
          function (t) {
      ...
      (y.enabled = !0),
        ...
        o.verified
          ? ((y.findByName("Username").findByName("Verified").enabled = !0),
            ...
            (y.element.width =
              y.findByName("Username").element.width + 70 + 20))
          : (y.element.width = y.findByName("Username").element.width + 70),
  ...
  (Overlay.prototype.setMeleeState = function (t) {
    (this.meleeKeyEntity.enabled = t),
      ...
      t
        ? ((this.meleeIcon.element.color = new pc.Color(1, 1, 1)),
  ...
  (Overlay.prototype.onDamage = function (t) {
    ...
    var e = this.cameraEntity.getPosition(),
      ...
      a =
        (Utils.lookAt(e.x, e.z, this.damagePosition.x, this.damagePosition.z) *
          pc.math.RAD_TO_DEG -
          i) %
        360;
  ...
  (Overlay.prototype.onKill = function (t, e) {
    ...
    "Kill" == e
      ...
      : "360d" == e
      ? ((i = "360 Degree Trick Shot"), (a = "Kill-360d"), (n = "God"))
      : "Revenge" == e
      ? ((i = "Revenge"), (a = "Revenge-Icon"), (n = "3x"))
      : "2x" == e
      ? ((i = "Double Kill"), (a = "Kill-2x"), (n = "2x"))
      : "3x" == e
      ? ((i = "Multi Kill"), (a = "Kill-3x"), (n = "3x"))
      : "4x" == e
      ? ((i = "Ultra Kill"), (a = "Kill-4x"), (n = "3x"))
      : "5x" == e
      ? ((i = "Unbreakable"), (a = "Kill-5x"), (n = "3x"))
      : "6x" == e
      ? ((i = "Unbelievable"), (a = "Kill-6x"), (n = "3x"))
      : "7x" == e
      ? ((i = "Savage"), (a = "Kill-7x"))
      : "8x" == e
      ? ((i = "Immortal"), (a = "Kill-8x"), (n = "3x"))
      : "9x" == e
  ...
  (Overlay.prototype.onAnnounce = function (t, e, i, a) {
    ...
    if (
      ...
      (this.announceTextBackground.element.width =
        this.announceTextEntity.element.width + 100),
  ...
  (Overlay.prototype.updateCrosshair = function (t) {
    ...
    if (
      ...
      var a = Utils.lookAt(
        e.x,
        e.z,
        this.ricochetPosition.x,
        this.ricochetPosition.z
      );
      (this.ricochetIndictator.element.opacity = pc.math.lerp(
        ...
        this.ricochetIndictator.setLocalEulerAngles(
          0,
          0,
          a * pc.math.RAD_TO_DEG - i
        );
    }
    if (this.damageTime > this.timestamp) {
      ...
      (this.damageIndictator.element.opacity = pc.math.lerp(
        ...
        this.damageIndictator.setLocalEulerAngles(
          0,
          0,
          n * pc.math.RAD_TO_DEG - i
        );
    }
  }),
  (Overlay.prototype.setAmmo = function () {
    ...
    this.focusBulletsMask.setLocalEulerAngles(
      0,
      0,
      -(this.maxAmmoValue - this.movement.currentWeapon.ammo) *
        this.ammoAngleFactor
    ),
  ...
  (Overlay.prototype.onNotification = function (t, e, i) {
    var a = 35 * -this.notifications.length,
      n = !1;
    if ("message" == t)
      ((n = this.notificationMessage.clone()).findByName(
        "Message"
      ).element.text = e),
      ...
      var s = e.killer.length + e.killed.length,
        o = e.killedSkin,
        l = e.killerSkin;
      ((n = this.notificationKill.clone()).findByName("Gibbon").element.color =
        e.color),
  ...
  (Overlay.prototype.onTick = function (t, e) {
    this.isOvertime
      ...
      t < 0 && !pc.isFinished
        ? ((this.alreadyStarted.enabled = !0),
          (this.alreadyStartedCount.element.text = 20 + t))
      ...
      t >= 0 && t <= 5
        ...
        : ((this.countBackEntity.enabled = !1),
          this.isOvertime &&
            !pc.isFinished &&
            this.entity.sound.play("Overtime-Count"));
  }),
...
Weapon.attributes.add("type", {
  ...
  (Weapon.prototype.stopShooting = function () {
    this.isAutomatic &&
      (this.entity.sound.stop("Fire"), this.entity.sound.play("Tail"));
  }),
...
EffectManager.attributes.add("shootRay", {
  ...
  (EffectManager.prototype.onKillSphere = function (t) {
    ...
    e.opacity = 1;
    var i = this.killSphereEntity
      .tween(this.killSphereEntity.getLocalScale())
      .to(
        {
          x: 15,
          y: 15,
  ...
  (EffectManager.prototype.onSkullShow = function (t) {
    ...
    this.skullEntity.setLocalPosition(e),
      ...
      (this.skullAnimation = this.skullEntity
        .tween(this.skullEntity.getLocalPosition())
        .to(
          {
            y: e.y + 1,
          },
  ...
  (EffectManager.prototype.onMapLoaded = function () {
    ...
    e.length > 0
      ...
      : ((i.enabled = !1), clearTimeout(this.thunderTimer));
  }),
  ...
  (EffectManager.prototype.updateLight = function () {
    ...
    t &&
      t.light &&
      ((t.light.shadowUpdateMode = pc.SHADOWUPDATE_THISFRAME),
  ...
  (EffectManager.prototype.onThrow = function (t, e, i, a, s) {
    ...
    r.setPosition(e),
      ...
      this.traceEntity.particlesystem &&
        this.traceEntity.particlesystem.reset();
    try {
  ...
  (EffectManager.prototype.setExplosion = function (t) {
    ...
    (t.exploded = !0),
      "Grenade" == t.type &&
        (this.loudSoundEntity.setPosition(e),
  ...
  (EffectManager.prototype.onShuriken = function (t, e, i, a, s) {
    ...
    h.setLocalPosition(t),
      ...
      l &&
        setTimeout(
          function (t, e, a) {
            (t.ray.enabled = !1), a && e.dealHitEntity("Shuriken", a, n, i, !0);
          },
          50,
          h,
          this,
  ...
  (EffectManager.prototype.dealHitEntity = function (t, e, i, a, s) {
    ...
    if (o.indexOf("Player") > -1) {
      ...
      if (Math.random() > 0.4 || "Melee" == t || "Shuriken" == t || "Dash" == t)
      ...
      "Shuriken" == t
        ? (this.entity.setPosition(e.point),
          (this.entity.sound.slots["Impact-Iron-Light"].pitch =
            0.1 * Math.random() + 1),
          this.entity.sound.play("Impact-Iron-Light"))
        : ("Melee" != t && "Dash" != t) ||
          (this.entity.setPosition(e.point),
          (this.entity.sound.slots["Impact-Iron"].pitch =
            0.1 * Math.random() + 1),
          this.entity.sound.play("Impact-Iron")),
  ...
  (EffectManager.prototype.onFire = function (t, e, i, a, s, n, o) {
    ...
    var r = this.shootRayIndex,
      l = (this.sparkIndex, this.app.systems.rigidbody.raycastFirst(t, e));
    if (l) {
      var p = 1;
      if (o) {
        var h = t.clone().sub(l.point.clone()).length();
        h > 10 && (p *= o), h > 30 && (p *= o), (s *= p);
      }
      ...
      if (d.indexOf("Player") > -1) {
      ...
      else if (d.indexOf("Explosive") > -1) l.entity.explode();
      else {
        var u = Math.round(180 * Math.random()),
          m = this.impactParticles[r];
        if (
          (m.setPosition(l.point),
          m.setEulerAngles(y),
        ...
        Date.now() - this.lastSmoke > 700 &&
          ...
          this.explosionSmokeEntity.particlesystem.play(),
          (this.lastSmoke = Date.now())),
          m.hole.setLocalScale(0.17, 0.17, 0.17),
          m.hole.setLocalEulerAngles(0, u, 0);
      }
      if (
        pc.controls.player.playerId == a &&
        l.entity.tags.list().indexOf("Player") > -1
      ) {
        var S = l.entity,
    ...
    if ("Melee" != n) {
      ...
      x.setPosition(i),
        ...
        x.sprite2.play("Fire"),
        "Shotgun" == n
          ? ((x.sprite1.opacity = 0.1),
            (x.sprite1.speed = 1.2),
            (x.sprite2.opacity = 0.1),
            (x.sprite2.speed = 1.2))
          : "Sniper" == n
          ? ((x.sprite1.opacity = 0.9),
            (x.sprite1.speed = 0.5),
            (x.sprite2.opacity = 0.9),
            (x.sprite2.speed = 0.5))
          : s > 40
          ? ((x.sprite1.opacity = 0.3),
            (x.sprite1.speed = 0.7),
            (x.sprite2.opacity = 0.3),
            (x.sprite2.speed = 0.7))
          : ((x.sprite1.opacity = 0.1),
            (x.sprite1.speed = 1.2),
            (x.sprite2.opacity = 0.1),
        ...
        pc.controls.player.playerId == a
          ? x.trace
              .tween(x.trace.getLocalPosition())
              .to(
                {
                  x: 0,
                  y: 0,
  ...
  (EffectManager.prototype.playMaterialImpact = function (t, e, i) {
    ...
    this.impactSoundEntity.setPosition(e.point),
      ...
      Math.random() > 0.4 &&
        "Melee" != i &&
        this.impactSoundEntity.sound.play("Ricochet-" + a);
  }),
  ...
  (EffectManager.prototype.update = function (t) {
    ...
    var e = this.cameraEntity.getPosition();
    this.explosionEntity.lookAt(e), this.skullEntity.lookAt(e);
  });
...
WeaponManager.attributes.add("defaultWeapon", {
  ...
  (WeaponManager.prototype.initialize = function () {
    (this.currentWeapon = !1),
      ...
      pc.session && pc.session.weapon
        ? this.setWeapon(pc.session.weapon)
    ...
    (this.weaponSkins = e),
      e &&
        setTimeout(
          function (e) {
            pc.session && pc.session.weapon
              ? e.setWeapon(pc.session.weapon)
              : e.setWeapon(e.defaultWeapon);
          },
          500,
          this
        );
  ...
  (WeaponManager.prototype.setSkin = function (e) {
    if (e && this.currentWeaponEntity) {
      var t = this.currentWeaponEntity.model.material.clone(),
        a = !1;
      e.search("Animated") > -1
        ? ((a = this.createAnimatedSkin(e)), (t.diffuseMap = a), t.update())
        : ((a = this.app.assets.find(e)),
          this.app.assets.load(a),
          a.ready(function (e) {
            (t.diffuseMap = a.resource), t.update();
          }));
      for (
        var n = this.currentWeaponEntity.model.meshInstances, i = 0;
        i < n.length;
        ++i
      ) {
        n[i].material = t;
  ...
  (WeaponManager.prototype.triggerShooting = function () {
    (this.currentFlameScale =
      Math.random() * (this.maxFlameScale / 2) + this.maxFlameScale),
      (this.currentFlameAngle = 360 * Math.random());
  }),
  (WeaponManager.prototype.setAnimation = function (e) {
    (this.currentFlameScale = pc.math.lerp(
      this.currentFlameScale,
      0.001,
      this.flameSpeed
    )),
      (this.currentFlameAngle = pc.math.lerpAngle(
        this.currentFlameAngle,
        0.001,
        0.1
      )),
...
Hitmarker.attributes.add("hitPointEntity", {
  ...
  (Hitmarker.prototype.onHitPoint = function (t, e) {
    ...
    n.on("update", function (t) {
      r.element.outlineColor.a = pc.math.lerp(r.element.outlineColor.a, 0, 0.1);
    }),
      n.start(),
      setTimeout(
        function (t) {
          t &&
            t.element &&
            t.element.color &&
            (t.element.color = pc.colors.white);
        },
        200,
        r
      ),
    ...
    if (this.points && this.points.length > 0)
      for (var e = this.points.length; e--; ) {
        ...
        i &&
          ((i.time -= t * this.speed),
          i.time < 0
            ? (i.destroy(), this.points.splice(e, 1))
            : this.trackPoint(i, t));
      }
  }),
  (Hitmarker.prototype.update = function (t) {
    this.updatePoints(t),
      Date.now() - this.lastHitTime > 250 &&
...
Rotate.attributes.add("axis", {
  ...
  (Rotate.prototype.initialize = function () {
    (this.currentElement = this.entity),
      (this.timestamp = 0),
      this.children &&
        (this.currentElement = this.entity.findByName(this.graphName));
  }),
  (Rotate.prototype.update = function (t) {
    var e = this.speed * (60 * t);
    this.waveStyle &&
      ((e = Math.cos(this.timestamp * this.speed) * this.waveWidth),
      (this.timestamp += 60 * t)),
      this.currentElement
...
NetworkManager.attributes.add("isDebug", {
  ...
  (NetworkManager.prototype.initialize = function () {
    "undefined" != typeof VERSION && (this.isDebug = !1),
      ...
      pc.session && void 0 !== pc.session.character
        ? ((this.characterName = pc.session.character),
  ...
  (NetworkManager.prototype.getRoomId = function (e) {
    ...
    if (((this.isSpectator = !1), t.length > 1)) {
      var i = t[1].split(":");
      return i.length > 1 && "Spectate" == i[0]
        ? ((this.isSpectator = !0), i[1])
        : t[1];
    }
    return !1;
  }),
  ...
  (NetworkManager.prototype.connect = function (e) {
    this.ws &&
      (this.ws.close(), (this.ws = !1), this.app.fire("Game:Finish", !0)),
      this.clearPlayers(),
      (this.keys = this.getKeys()),
  ...
  (NetworkManager.prototype.send = function (e) {
    this.ws &&
      ...
      this.ws.send(this.pack.encode(e));
  }),
  (NetworkManager.prototype.parse = function (e) {
    if (0 === e.length) return !1;
    var t = e[0];
    Object.keys(this.keys).indexOf(t) > -1 &&
      this[this.keys[t]](e.splice(1, e.length + 1));
  }),
  ...
  (NetworkManager.prototype.mode = function (e) {
    ...
    this.app.fire("Game:PreStart", !0), this.app.fire("Outline:Restart", !0);
    var r = e[1];
    if (
  ...
  (NetworkManager.prototype.setThrow = function (e, t, i) {
    "Grenade" == e
      ? this.send([this.keys.throw, e, t.x, t.y, t.z, i.x, i.y, i.z])
      : "Shuriken" == e &&
        this.send([this.keys.throw, e, t.x, t.y, t.z, i[0], i[1], i[2]]);
  }),
  (NetworkManager.prototype.throw = function (e) {
    if (e.length > 0) {
      ...
      if ("Grenade" == t) {
        ...
        "Shuriken" == t &&
          this.app.fire("EffectManager:Shuriken", c, [s, o, n], p, h, !1);
    }
  }),
  ...
  (NetworkManager.prototype.character = function (e) {
    if (e.length > 0) {
      var t = this.getPlayerById(e[0]),
        ...
        r = e[2];
      e[0] == this.playerId
        ? this.app.fire("Player:Dance", r)
        : t && t.script.enemy.setCharacterSkin(i, !1, r);
    }
  }),
  ...
  (NetworkManager.prototype.payload = function (e) {
    e.length > 0 &&
      (this.app.fire("Objective:Payload", e[0]),
  ...
  (NetworkManager.prototype.objective = function (e) {
    e.length > 0 &&
      "POINT" == this.options.gameMode &&
      (this.app.fire("Mode:NextObjective", e[0]),
      (pc.nextObjectivePoint = e[0]));
  }),
  (NetworkManager.prototype.finish = function (e) {
    if ((this.app.fire("Game:Overtime", !1), e.length > 0)) {
      var t = "none",
        i = e[0];
      for (var r in i) {
        var a = i[r];
        a.id == this.playerId ? ((a.isMe = !0), (t = a.team)) : (a.isMe = !1);
      }
      (pc.stats = i),
        "FFA" == pc.currentMode || "POINT" == pc.currentMode
          ? !0 === i[0].isMe
            ? (pc.isVictory = !0)
            : (pc.isVictory = !1)
  ...
  (NetworkManager.prototype.board = function (e) {
    if (e.length > 0) {
      ...
      for (var i in e[0]) {
        var r = e[0][i];
        r.playerId == this.playerId ? (r.isMe = !0) : (r.isMe = !1), t.push(r);
      }
  ...
  (NetworkManager.prototype.announce = function (e) {
    ...
    t &&
      (i == this.playerId &&
        "affected" != t &&
        this.app.fire("Player:Kill", r, a),
      "affected" == t &&
        s &&
        (this.app.fire(
          "Overlay:Notification",
          "message",
          '[color="#58E6FA"]' + s.username + "[/color] affected by " + a,
          !1
        ),
      ...
      "objective" == t &&
        ...
        this.app.fire(
          "Overlay:Notification",
          "message",
          '[color="#58E6FA"]' + s.username + "[/color] captured point!",
          !1
        ),
      "kill" == t &&
        s &&
        ...
        this.app.fire(
          "Overlay:Notification",
          "message",
          '[color="#58E6FA"]' + s.username + "[/color] suicided!",
          !1
        ));
  }),
  ...
  (NetworkManager.prototype.unlock = function (e) {
    ...
    if (
      ...
      this.app.fire(
        "Overlay:Notification",
        "message",
        '[color="#58E6FA"]' + s + "[/color] unlocked " + i + " abilities!",
        !1
      );
    }
  }),
  (NetworkManager.prototype.kill = function (e) {
    ...
    t == this.playerId
      ? this.app.fire("Player:Death", s, r)
      : a && a.script.enemy.death(r);
  }),
  (NetworkManager.prototype.health = function (e) {
    var t = e[0],
      ...
      r = this.getPlayerById(t);
    t == this.playerId
      ? this.app.fire("Player:Health", i)
      : r && r.script.enemy.setHealth(i);
  }),
  ...
  (NetworkManager.prototype.chat = function (e) {
    if (e.length > 0) {
      var t = e[0],
        ...
        r = e[1];
      "console" == t
        ? this.app.fire("Chat:Message", "Console", r)
        : t == this.playerId
        ? this.app.fire("Chat:Message", this.username, r, !0)
        : this.app.fire("Chat:Message", i.username, r);
    }
  }),
  ...
  (NetworkManager.prototype.team_set = function (e) {
    if (e.length > 0) {
      var t = e[0],
        ...
        r = this.getPlayerById(t);
      t == this.playerId
        ? (this.app.fire("Player:Team", i),
          (pc.currentTeam = i),
          (this.team = i))
        : r && r.script.enemy.setTeam(i);
    }
  }),
...
Player.attributes.add("playerId", {
  ...
  (Player.prototype.onCharacterSet = function (t) {
    ...
    (e.enabled = !0),
      ...
      (this.characterArmLeft.model.asset = this.app.assets.find(
        t + "-RightArm"
      )),
      (this.characterArmRight.model.asset = this.app.assets.find(
        t + "-LeftArm"
      ));
    ...
    "Lilium" == t
      ? ((this.hammerEntity.enabled = !0), (this.throwCooldown = 10))
      : "Shin" == t &&
        ((this.katanaEntity.enabled = !0), (this.throwCooldown = 3));
  }),
  ...
  (Player.prototype.onCharacterSkinSet = function (t) {
    ...
    if (t && this.characterEntity) {
      for (
        var a = this.characterEntity.model.material.clone(),
          i = this.app.assets.find(e),
      ...
      this.app.assets.load(i),
        i.ready(function (t) {
          (a.diffuseMap = i.resource), a.update();
        });
    }
  }),
  ...
  (Player.prototype.onStart = function () {
    pc.session && void 0 !== pc.session.character
      ? this.app.fire("Player:Character", pc.session.character)
  ...
  (Player.prototype.onPointerLock = function () {
    this.app.fire("Overlay:Pause", !1), this.app.mouse.enablePointerLock();
  }),
  ...
  (Player.prototype.checkShooting = function () {
    var t = !1;
    this.movement.isReloading < this.movement.timestamp &&
      this.movement.leftMouse &&
      (t = !0),
  ...
  (Player.prototype.setDeathAnimation = function () {
    ...
    this.characterCameraHolder.setLocalEulerAngles(
      0,
      a * pc.math.RAD_TO_DEG,
      0
    );
  }),
  ...
  (Player.prototype.updateEmotePlaying = function () {
    this.setBackRaycast(),
      (this.animation.lookX = pc.math.lerp(
        this.animation.lookX,
        this.movement.lookX,
        0.05
      )),
      ...
      this.isDeath
        ? (this.isCircularMenuActive &&
            ...
            this.app.keyboard.wasPressed(pc.KEY_2) &&
              this.setWeapon(this.weapons[1]),
            this.app.keyboard.wasPressed(pc.KEY_3) &&
              this.setWeapon(this.weapons[2]),
            this.app.keyboard.wasPressed(pc.KEY_4) &&
              this.setWeapon(this.weapons[3])),
          !1)
  ...
  (Player.prototype.setWeapon = function (t) {
    this.movement.disableZoom(), this.weaponManager.setWeapon(t);
  }),
...
Enemy.attributes.add("playerId", {
  ...
  (Enemy.prototype.setUsername = function (t, i) {
    (this.entity.script.label.enabled = !0),
      ...
      this.isActivated
        ...
        : this.entity.script.label.setUsername(t, i);
  }),
  ...
  (Enemy.prototype.setCharacterSkin = function (t, i, e) {
    if (this.isActivated)
      return (
        (this.entity.collision.height = 1.5),
  ...
  (Enemy.prototype.loadCharacterParts = function () {
    ...
    "Lilium" == this.skin
      ? ((this.headEntity = this.characterEntity.findByName("Character1_Head")),
        (this.spineEntity = this.characterEntity.findByName(
          "Character1_Spine2"
        )),
        (this.handEntity = this.characterEntity.findByName(
  ...
  (Enemy.prototype.setAnimation = function (t, i) {
    this.currentAnimation != t &&
      ...
      (this.characterEntity.animation.play(t, i), (this.currentAnimation = t));
  }),
  ...
  (Enemy.prototype.respawn = function () {
    this.teleport(),
      ...
      (this.timeout.respawn = setTimeout(
        function (t) {
          t && (t.showCharacter(), t.setAnimation("Idle"), (t.isDeath = !1));
        },
        800,
        this
      ));
  ...
  (Enemy.prototype.damage = function (t, i, e) {
    ...
    if (
      ...
      this.skinMaterial &&
        ((this.skinMaterial.emissiveIntensity = 0.65),
      ...
      clearTimeout(this.skinMaterialTimer),
        (this.skinMaterialTimer = setTimeout(
          function (t) {
      ...
      ("TDM" != pc.currentMode && "PAYLOAD" != pc.currentMode) ||
        (pc.currentTeam == this.team &&
          ((h = !1), this.app.fire("Overlay:FriendlyFire", !0))),
        h &&
          (this.app.fire(
            "Hit:Point",
            this.entity,
        ...
        (this.lastDamage = Date.now()),
        ("TDM" != pc.currentMode && "PAYLOAD" != pc.currentMode) ||
          this.app.fire("Outline:Add", this.characterEntity);
    }
  ...
  (Enemy.prototype.disableDamage = function () {
    return (
      !!this.entity.collision &&
      !this.isActivated &&
      void (this.entity.collision.enabled = !1)
    );
  }),
  (Enemy.prototype.enableDamage = function () {
    return (
      !!this.entity.collision &&
      !this.isActivated &&
      void (this.entity.collision.enabled = !0)
    );
  }),
  ...
  (Enemy.prototype.setHealth = function (t) {
    (this.health = t), this.entity.script.label.setHealth(this.health);
  }),
  (Enemy.prototype.shoot = function () {
    ...
    (this.entity.sound.slots[o].pitch = 1 - 0.1 * Math.random()),
  ...
  (Enemy.prototype.setDirection = function () {
    ...
    if (
      ...
      var i = Math.min(
        Math.max(
          this.speed / pc.variables.enemySpeed,
          pc.variables.minEnemySpeed
        ),
        pc.variables.maxEnemySpeed
      );
      "none" != this.lastDirection &&
        this.setAnimation(this.lastDirection, 0.1),
        (this.characterEntity.animation.speed = pc.math.lerp(
          this.characterEntity.animation.speed,
          i,
          0.3
        )),
        this.entity.sound.slots.Footsteps.isPlaying ||
          this.entity.sound.play("Footsteps"),
        (this.lastDirection = t);
    } else this.entity.sound.stop("Footsteps"), this.setAnimation("Idle", 0.2);
  }),
  ...
  (Enemy.prototype.setMovement = function (t) {
    if (
      ((this.speed = this.entity
        .getPosition()
        .clone()
        .sub(this.nextPosition.clone())
        .length()),
      this.speed > 20 && this.teleport(),
      (this.tempAngle = this.tempAngle.lerp(
        this.tempAngle,
        Utils.zeroVector,
        0.1
      )),
      ...
      (this.currentAngle.x = pc.math.lerpAngle(
        this.currentAngle.x,
        this.nextAngle.x,
        this.delta
      )),
      (this.currentAngle.y = pc.math.lerpAngle(
        this.currentAngle.y,
        this.nextAngle.y,
        this.delta
      )),
    ...
    var i =
      ...
      this.tempAngle.x * pc.math.RAD_TO_DEG;
  ...
  (MapManager.prototype.clearHolder = function (t) {
    ...
    a &&
      (a.on("destroy", function () {
        console.log("Destroy properly completed!"), t();
      }),
      a.destroy());
  });
...
Menu.attributes.add("cameraEntity", {
  ...
  (Menu.prototype.initialize = function () {
    if (
      ...
      "undefined" != typeof VERSION_CODE &&
        (this.versionEntity.element.text = "v" + VERSION_CODE),
      ...
      this.app.fire(
        ...
        function () {
          pc.app.fire("Ads:BannerSet", "venge-io_728x90", "728x90"),
            pc.app.fire(
              "Alert:Menu",
              "Please disable adblock to enable rewards!"
            ),
            (pc.app.systems.sound.volume = 0.25);
        }
      ),
  ...
  (Menu.prototype.onSaveUUID = function () {
    this.mobileUUID &&
      ...
      setTimeout(
        function (e) {
          (e.mobileWaiting.enabled = !1), window.location.reload(!0);
        },
        1e3,
        this
      ));
  ...
  (Menu.prototype.setKeyboardTable = function (e) {
    ...
    if (e) {
      for (var n in t) {
        t[n].default_key == e.default_key &&
          (t[n].waiting = "Waiting for prompt...");
      }
  ...
  (Menu.prototype.setHome = function (e) {
    return (
      ...
      !!this.youtubeName &&
      ("undefined" != typeof VERSION_CODE &&
        (VERSION_CODE == e.version ||
          pc.isMobile ||
          ((this.updateEntity.enabled = !0),
          (this.updateVersionEntity.element.text = e.version))),
      !!this.twitchButton &&
        (e.display_name && Math.random() > 0.2
          ? ((this.youtubeButton.enabled = !1),
            (this.twitchButton.enabled = !0),
            (this.twitchName.element.text = e.display_name),
            (this.twitchButton.element.width =
              this.twitchName.element.calculatedWidth + 50),
            (this.twitchButton.script.button.triggerFunction =
              'window.open("https://www.twitch.tv/' + e.username + '");'))
          : ((this.twitchButton.enabled = !1),
            (this.youtubeButton.enabled = !0),
            (this.youtubeName.element.text = e.youtuber.name),
            (this.youtubeButton.element.width =
              this.youtubeName.element.calculatedWidth + 50),
            (this.youtubeButton.script.button.triggerFunction =
              'window.open("' + e.youtuber.link + '");')),
  ...
  (Menu.prototype.onProfileData = function (e) {
    ...
    e &&
      ((pc.session.hash = e.hash),
      (pc.session.username = e.username),
      Utils.setItem("Hash", e.hash),
      e.username &&
        this.miniProfileEntity &&
        this.miniProfileEntity.element &&
        (this.miniProfileEntity.element.width = 415 + 3.5 * e.username.length));
  }),
  (Menu.prototype.onDestroy = function (e) {
    this.app.off("Sound:Play"), this.app.off("Player:Weapon");
  }),
  ...
  (Menu.prototype.onCharacterSelect = function (e) {
    ...
    (a.enabled = !0),
      ...
      this.entity.sound.play("Whoosh"),
      "Lilium" == e
        ? ((this.meleeIcon.element.textureAsset = this.app.assets.find(
            "Lilium-Melee.png"
          )),
          (this.throwIcon.element.textureAsset = this.app.assets.find(
            "Grenade-Icon.png"
          )))
        : "Shin" == e &&
          ((this.meleeIcon.element.textureAsset = this.app.assets.find(
  ...
  (Menu.prototype.checkScreenSize = function () {
    if (
      window.innerWidth != this.currentWidth ||
...
Object.assign(
  ...
  (function () {
    ...
    return (
      ((t.prototype = Object.create(pc.PostEffect.prototype)).constructor = t),
...
Label.attributes.add("headPoint", {
  ...
  (Label.prototype.setInitalize = function () {
    pc.isSpectator
      ...
      pc.isSpectator &&
        (this.currentCamera = this.spectatorCameraEntity.camera),
      (this.isInitalized = !0);
  }),
  ...
  (Label.prototype.updateTeamColor = function () {
    if (
      !(
        this.healthBarEntity &&
        this.healthBarEntity.element &&
        this.healthBarEntity.element.color
      )
    )
      return !1;
  ...
  (Label.prototype.setHealth = function (t) {
    ...
    (e = Math.max(e, 0)),
      ...
      (this.whiteBarEntity.element.opacity = 0.8),
      this.whiteBarEntity
        ...
        .start(),
      this.whiteBarEntity
        .tween(this.whiteBarEntity.element)
        .to(
          {
            opacity: 0,
          },
  ...
  (Label.prototype.checkVisibility = function () {
    var t = this.app.systems.camera.cameras[0],
      e = this.app.systems.rigidbody.raycastFirst(
        this.entity.getPosition(),
        t.getPosition()
      );
    e && e.entity && "Player" == e.entity.name
      ? (this.isVisible = !0)
      : (this.isVisible = !1);
  }),
...
Result.attributes.add("topLine", {
  ...
  (Result.prototype.setBanner = function () {
    Utils.isMobile()
      ? this.app.fire("Ads:BannerSet", "venge-io_320x50_2", "320x50")
      : this.app.fire("Ads:BannerSet", "venge-io_728x90_2", "728x90");
  }),
  ...
  (Result.prototype.onStateChange = function (t) {
    t
      ? (this.app.on("Overlay:Votes", this.onVotes, this),
        ...
        this.setVoteEntities(["Sierra", "Xibalba", "Mistle"]))
      : (this.app.off("Overlay:Votes"), this.app.off("Overlay:WatchAds"));
  }),
  ...
  (Result.prototype.tick = function () {
    if (
      !this.timerEntity ||
      !this.timerEntity.element ||
      !this.timerEntity.element.text
    )
      return !1;
    var t = Math.max(this.time, 0);
    t >= 0 && t <= 5
      ? ((this.timerEntity.element.text =
          'GET READY - [color="#ffc703"]' + t + "[/color]"),
        this.time > -1 && this.entity.sound.play("Count"))
      : (this.timerEntity.element.text =
          'NEXT GAME : [color="#ffc703"]' + t + "[/color]");
    var e = this.time - 10;
    (e = Math.max(e, 0)),
      this.time--,
      t >= 0 &&
  ...
  (Result.prototype.setVoteEntities = function (t) {
    for (var e in (this.clearVoteEntities(), t)) {
      ...
      (a.name = i + "-Map"),
        ...
        a.setLocalPosition(
          0,
          -this.mapEntities.length * (a.element.height + this.padding),
          0
        ),
        (a.findByName("Name").element.text = i),
        (a.findByName("Picture").element.textureAsset = s),
        (a.findByName("VoteButton").script.button.triggerFunction =
          'result.vote("' + i + '");'),
  ...
  (Result.prototype.onVotes = function (t) {
    ...
    for (var i in t) {
      ...
      a &&
        ((a.findByName("VoteCount").element.text = s + ""),
  ...
  (Result.prototype.showScoreTable = function (t) {
    for (var e in ((this.scoresEntity.enabled = !0), this.clearStats(), t)) {
      var i = t[e];
  ...
  (Result.prototype.createPlayerRow = function (t, e) {
    ...
    (i.enabled = !0),
      ...
      (u = this.app.assets.find("Tier-" + t.tier + ".png")) &&
        (i.findByName("Tier").element.textureAsset = u),
      (i.findByName("Status").element.color =
        1 == e ? this.victoryColor : this.defeatColor),
      t.isMe
        ? (i.findByName("You").enabled = !0)
    ...
    a &&
      a.script &&
      a.script.button &&
      (a.script.button.fireFunction = "Follow:User@" + t.username),
      (this.rankOpacity -= 0.4);
    var n = (this.players.length % 2) + 2;
    1 === e
      ? ((n = 1), (i.element.opacity = 0.15))
      : (i.element.opacity = this.players.length % 2 ? 0.08 : 0.05);
...
Input.attributes.add("placeholder", {
  ...
  (Input.prototype.initialize = function () {
    ...
    (this.element.style.color = t),
      ...
      Utils.getItem(this.entity._guid) &&
        this.setValue(Utils.getItem(this.entity._guid)),
      this.updateStyle(),
  ...
  (Input.prototype.setResultValue = function (t) {
    ...
    var e = t.result;
    this.element
      ? ((this.element.value = e), (this.sleepValue = !1))
      : (this.sleepValue = e);
  }),
  (Input.prototype.setValue = function (t) {
    this.element
      ? ((this.element.value = t), (this.sleepValue = !1))
      : (this.sleepValue = t);
  }),
...
Chat.attributes.add("inputEntity", {
  ...
  (Chat.prototype.nextMessage = function () {
    ...
    if (t > 0)
      for (var e = 0; t--; )
        this.messages[t].setLocalPosition(
          0,
          (this.messages.length - t) * this.padding + e,
          0
        ),
  ...
  (Chat.prototype.onMessage = function (t, e, s, i) {
    ...
    (a.enabled = !0),
      ...
      (a.findByName("Text").element.text =
        t + ' : [color="#01A9DB"]' + e + "[/color]"),
      (a.element.height = a.findByName("Text").element.height + 10),
      (a.findByName("Text").element.color = i
        ? this.consoleColor
        : s
        ? this.meColor
        : this.whiteColor),
...
Speaking.attributes.add("subtitles", {
  ...
  (Speaking.prototype.play = function (t, e) {
    ...
    var i = this.currentIndex + 1,
      ...
      n = Object.keys(pc.app.root.findByName("Speaking").sound.slots).indexOf(
        a
      );
    this.entity.sound.play(a),
...
Count.attributes.add("leftPad", {
  ...
  (Count.prototype.update = function (t) {
    ...
    (this.entity.element.text = this.leftPad + e + this.rightPad),
      (this.currentNumber = pc.math.lerp(this.currentNumber, this.next, 0.1));
  });
...
Terrain.attributes.add("map", {
  ...
  (Terrain.prototype.initialize = function () {
    ...
    (this.shader = ""),
      ...
      (this.shader += "    \n"),
      (this.shader +=
        "    vec3 baseTexture = texture2DSRGB(mapTexture, $UV).$CH;\n"),
      (this.shader += "    \n"),
      (this.shader +=
...
Object.assign(
  ...
  (function () {
    ...
    return (
      ((e.prototype = Object.create(pc.PostEffect.prototype)).constructor = e),
...
Waterfall.attributes.add("noise_1", {
  ...
  (Waterfall.prototype.onSettingsChange = function () {
    pc.settings &&
      !0 === pc.settings.disableSpecialEffects &&
...
Button.attributes.add("connected", {
  ...
  (Button.prototype.onPressFire = function (event) {
    if (
      ...
      this.waitResolve &&
        (this.spinner &&
          ((this.spinner.enabled = !0), (this.text.enabled = !1)),
    ...
    else eval(this.triggerFunction);
...
Point.attributes.add("playerEntity", {
  ...
  (Point.prototype.update = function () {
    ...
    i.worldToScreen(a, t),
      ...
      (t.y *= e),
      t.x > 0 &&
      t.x < this.app.graphicsDevice.width &&
      t.y > 0 &&
      t.y < this.app.graphicsDevice.height &&
      t.z > 0
        ? (this.labelEntity.setLocalPosition(t.x / n, (s.height - t.y) / n, 0),
          (this.labelEntity.enabled = !0))
        : (this.labelEntity.enabled = !1);
  });
var wrapper;
"undefined" != typeof VERSION &&
  ...
  window.addEventListener("keydown", function (e) {
    32 == e.keyCode && e.target == document.body && e.preventDefault(),
      9 != e.which ||
        (e.target != document.body && !pc.isMapLoaded) ||
  ...
  window.location && window.location.href.search("isMobile") > -1
    ? (pc.isMobile = !0)
    : (pc.isMobile = !1),
  pc.script.createLoadingScreen(function (e) {
    ...
    (t = [
      ...
      (function () {
        ((wrapper = document.createElement("div")).id =
          "application-splash-wrapper"),
...
SpellManager.attributes.add("playerEntity", {
  ...
  (SpellManager.prototype.onGameStart = function () {
    "Lilium" == this.characterName
      ? (this.player.throwCooldown = 10)
      : "Shin" == this.characterName && (this.player.throwCooldown = 3),
      (this.isReducedApplied = !1);
  }),
  ...
  (SpellManager.prototype.onEffectTrigger = function (e) {
    if ("Wind" == e) {
      var t = 1.367,
        i = 0.878;
      this.cameraEntity.camera.fov > 75 && ((t = 1.972), (i = 1.266)),
    ...
    this.entity.sound.play("Ice-Break"),
      ...
      this.weaponMaterial &&
        ...
        this.armsEntityMaterial &&
          ((this.armsEntityMaterial.emissiveMap = !1),
          this.armsEntityMaterial.update())),
      setTimeout(
        function (e) {
  ...
  (Tab.prototype.onTabChange = function (t) {
    ...
    for (var n in this.menuItems) {
      ...
      if (this.onlyTabs)
        ...
        var s = this.page[n];
        i.name == t
          ? ((i.element.opacity = 1), (s.enabled = !0))
          : ((i.element.opacity = 0), (s.enabled = !1));
      }
    }
...
Page.attributes.add("activeOpacity", {
  ...
  (Page.prototype.initialize = function () {
    this.app.on("Page:" + this.entity.name, this.setPage, this),
      this.activePage &&
        this.app.fire("Page:" + this.entity.name, this.activePage);
  }),
  (Page.prototype.setPage = function (t) {
    ...
    for (var i in e) {
      var n = e[i],
        p = a[i];
      n.name == t
        ? ((n.enabled = !0), (p.element.opacity = this.activeOpacity))
        : ((n.enabled = !1), (p.element.opacity = this.defaultOpacity));
    }
  });
...
Fetcher.attributes.add("auto", {
  ...
  (Fetcher.prototype.preprocess = function (t) {
    var e = t;
    return (e = (e = (e = e.replace("$hash", this.getRoomId())).replace(
      "$session",
      this.getSession()
    )).replace("$is_mobile", pc.isMobile));
  }),
  (Fetcher.prototype.onFetch = function (t) {
    t && (this.data = t);
    var e = this.preprocess(this.URL);
    this.onLoading(), this.fetch(e, this.data, this.onResult.bind(this));
  }),
...
Form.attributes.add("inputs", {
  ...
  (Form.prototype.update = function () {
    this.app.keyboard.wasPressed(pc.KEY_ENTER) &&
      this.app.fire("Form:" + this.entity.name, !0);
  });
...
Table.attributes.add("labels", {
  ...
  (Table.prototype._onInit = function () {
    ...
    (t += "table { border-collapse: collapse; }"),
      ...
      (t +=
        "table, .verification { height:16px; float:left; margin-right: 5px; }"),
      (t +=
        ...
        "; }"),
      (t +=
        "table, tr th { text-align:left; font-size:12px; background-color:" +
        ("rgba(" +
    ...
    for (var n in (this.table.appendChild(i), this.labels)) {
      var a = this.labels[n],
  ...
  (Table.prototype.createButtons = function (t, e, i) {
    if (t[e] && t[e].match(/\$button\[(.*?)\]/)) {
      ...
      ((o = document.createElement("button")).innerText = s[0]),
        ...
        (o.onclick = function () {
          var t = {};
          (t[this._key] = this._value), pc.app.fire(this.trigger, t);
        }),
        i.appendChild(o);
    } else
    ...
    for (var i in (t = t.result)) {
      ...
      for (var r in this.keys) {
        ...
        if (s.search("\\$verified") > -1) {
          ...
          "1" == n.verified &&
            (l = '<img src="' + e.getFileUrl() + '" class="verification">'),
            (o.innerHTML = l + " " + n[h]);
        } else
          "$thumbnail" == s
            ? this.createThumbnail(n, o)
            : "$button" == s ||
              "$button" == n[s] ||
              (n[s] && n[s].length > 0 && n[s].search("\\$button") > -1)
            ? this.createButtons(n, s, o)
            : "$index" == s
            ? (o.innerText = parseInt(i) + 1)
            : (o.innerHTML = n[s]);
        a.appendChild(o);
      }
      this.table.appendChild(a), this.rows.push(a);
    }
  }),
...
Template.attributes.add("autoRefresh", {
  ...
  (Template.prototype.render = function (data, text) {
    for (
      var regex = /\{\{(.*?)\}\}/gm, str = text, m;
      null !== (m = regex.exec(text));

    ) {
      m.index === regex.lastIndex && regex.lastIndex++;
      var content = m[1],
        variable = m[1];
      (variable = variable.split(" | ")), (variable = variable[0]);
      try {
    ...
    for (var t = this.entity.findByTag("Dynamic"), r = t.length; r--; ) {
      ...
      if (i && i.enabled) {
        if (i.element.type == pc.ELEMENTTYPE_TEXT) {
          ...
          i.element.source
            ? (i.element.text = i.element.source + "")
            : (i.element.source = a),
        ...
        if (i.element.type == pc.ELEMENTTYPE_IMAGE) {
          ...
          if (((i.element.sourceImage = n), i.element.sourceImage)) {
            var o = i.element.sourceImage;
            i.element.textureAsset = o;
          } else i.element.sourceImage = n;
...
Bar.attributes.add("key", {
  ...
  Bar.attributes.add("isParticle", {
    ...
    default: !1,
    description:
      "Do you want to enable particle (sprite animation)? Dependents on Sprite.js",
  }),
  ...
  Bar.attributes.add("isFillColorChange", {
    ...
    default: !1,
    description:
      "Do you want to enable bar color change, based on its fill status?",
  }),
    ...
    t[this.start] && this.entity.setLocalScale(t[this.start], 1, 1),
      a > 0
        ? this.isAnimated
          ...
          : this.entity.setLocalScale(a, 1, 1)
...
Popup.attributes.add("title", {
  ...
  (Popup.prototype.initialize = function () {
    this.on(
      ...
      function (t) {
        this.entity.enabled ||
          (this.wrapper && this.wrapper.remove(), (pc.isButtonLocked = !1));
      },
      this
    ),
  ...
  (Popup.prototype._onInit = function () {
    ...
    if (
      ...
      (r.innerHTML = n), (r.id = "popup-style"), document.body.appendChild(r);
    }
  ...
  (Alert.prototype.onAlert = function (t) {
    ...
    e.length > 0 &&
      e.forEach(function (t) {
        ...
        (t.currentDisplay = e), (t.style.display = "none");
      }),
      setTimeout(
        function (e) {
          e._onAlert(t);
...
RoomManager.attributes.add("isDebug", {
  ...
  (RoomManager.prototype.send = function (t) {
    this.ws &&
      this.ws.readyState == this.ws.OPEN &&
      this.ws.send(this.pack.encode(t));
  }),
  (RoomManager.prototype.parse = function (t) {
    if (0 === t.length) return !1;
    var e = t[0];
    Object.keys(this.keys).indexOf(e) > -1 &&
      this[this.keys[e]](t.splice(1, t.length + 1));
  }),
  ...
  (RoomManager.prototype.onStart = function () {
    1 === this.currentUsernames.length
      ? (this.app.fire("Confirm:Menu", "Please wait for friends!"),
...
Container.attributes.add("id", {
  ...
  (Container.prototype.initialize = function () {
    if (Utils.isMobile()) {
      if ("Desktop" == this.showOnly) return this.entity.destroy(), !1;
    } else if ("Mobile" == this.showOnly) return this.entity.destroy(), !1;
    (this.isDestroyed = !1),
...
(Analytics.prototype.initialize = function () {
  ...
  (Analytics.prototype.onGameplayStart = function () {
    if (Date.now() - this.lastGameStart < 1e3) return !1;
...
Checkbox.attributes.add("default", {
  ...
  (Checkbox.prototype.setValue = function (e) {
    this.element
      ? ((this.element.checked = e), (this.sleepValue = !1))
      : (this.sleepValue = e);
  }),
...
MobileController.attributes.add("joystickEntity", {
  ...
  (MobileController.prototype.initialize = function () {
    if (
      (this.app.touch || console.log("Mobile controllers are not available!"),
      !Utils.isMobile())
    )
      return (
  ...
  (MobileController.prototype.onJoystickMove = function (t) {
    (this.movement.dx = this.movement.startX - t.x),
      ...
      (this.movement.x = t.x),
      (this.movement.y = t.y),
      this.joystickCenterEntity.setLocalPosition(
        -this.movement.dx,
        this.movement.dy,
        0
      );
...
AdsManager.attributes.add("defaultProvider", {
  ...
  (AdsManager.prototype.initialize = function () {
    "undefined" != typeof adblocked && !0 === adblocked && (isAdsBlocked = !0),
      ...
      "undefined" == typeof adsProvider || pc.isMobile
        ? ((SDKLoaded = !1),
          (this.type = this.setAdsProvider()),
          this.initalizeSDK())
        : (this.type = adsProvider.type),
  ...
  (AdsManager.prototype.onBannerSet = function (e, t) {
    ...
    if ("Adinplay" == this.type)
      ...
      i
        ? ((i.innerHTML =
            '<div class="adsbyvli" data-ad-slot="' +
            this.bannerSlotId +
            '"></div>'),
          setTimeout(
            function (e) {
      ...
      "Poki" == this.type &&
      "undefined" != typeof PokiSDK &&
      Date.now() - this.lastBannerSetTime > 3e4
    ) {
      this.lastPokiBannerContainer &&
        (PokiSDK.destroyAd(this.lastPokiBannerContainer),
        (this.lastPokiBannerContainer = !1));
  ...
  (AdsManager.prototype.onVLI = function () {
    ...
    (t.innerHTML =
      '<div class="adsbyvli" data-ad-slot="' + this.prerollSlotId + '"></div>'),
      document.body.appendChild(t),
      (SDKLoaded = !0);
  }),
  (AdsManager.prototype.onPokiSDK = function () {
    PokiSDK.init()
      .then(function () {
        console.log("Poki SDK successfully initialized"), (SDKLoaded = !0);
      })
      .catch(function () {
  ...
  (AdsManager.prototype.setAdsProvider = function () {
    ...
    return window.location && window.location.href.search("poki") > -1
      ? "Poki"
...
Spectator.attributes.add("defaultSensitivity", {
  ...
  (Spectator.prototype.onMouseDown = function (t) {
    ...
    this.rightClick && 2 == t.button
      ? this.app.mouse.enablePointerLock()
      : this.rightClick || this.app.mouse.enablePointerLock();
  }),
  ...
  (Spectator.prototype.onMouseMove = function (t) {
    return (
      ...
      void (this.lookY -=
        t.dx * this.defaultSensitivity * pc.settings.sensivity))
    );
  }),
  ...
  (Spectator.prototype.setKeyboard = function () {
    ...
    this.app.keyboard.wasPressed(pc.KEY_1) &&
      ((this.targetIndex = 0), this.focusTarget()),
      this.app.keyboard.wasPressed(pc.KEY_2) &&
        ((this.targetIndex = 1), this.focusTarget()),
      this.app.keyboard.wasPressed(pc.KEY_3) &&
        ((this.targetIndex = 2), this.focusTarget()),
      this.app.keyboard.wasPressed(pc.KEY_4) &&
        ((this.targetIndex = 3), this.focusTarget()),
      this.app.keyboard.wasPressed(pc.KEY_5) &&
        ((this.targetIndex = 4), this.focusTarget()),
      "Free" == this.mode &&
        ...
        this.app.keyboard.isPressed(pc.KEY_D) &&
          this.entity.translateLocal(this.speed, 0, 0),
        this.app.keyboard.isPressed(pc.KEY_E) &&
          this.entity.translate(0, this.speed, 0),
        this.app.keyboard.isPressed(pc.KEY_Q) &&
          this.entity.translate(0, -this.speed, 0));
  }),
...
Preview.attributes.add("baseEntity", {
  ...
  (Preview.prototype.onStateChange = function (t) {
    (this.state = t), !1 === t && this.entity.sound.stop("Emote");
  }),
  ...
  (Preview.prototype.setSkin = function (t, e) {
    ...
    if (e && t) {
      ...
      this.app.assets.load(s),
        s.ready(function (t) {
          (n.diffuseMap = s.resource), n.update();
        });
    }
  }),
  ...
  (Preview.prototype.onSet = function (t, e) {
    this.entity.sound.stop("Emote"),
      ...
      "ShotgunSkin" == e &&
        ((this.shotgunSkin.enabled = !0),
        this.setSkin(this.shotgunSkin, t.filename)),
      "SniperSkin" == e &&
        ((this.sniperSkin.enabled = !0),
  ...
  (Preview.prototype.update = function (t) {
    ...
    return this.isOpening
      ? (this.lidEntity &&
        ...
        !1)
      : !this.isStatic &&
          (this.isDragging || (this.lookAngle -= 10 * t),
...
Shop.attributes.add("shopType", {
      ...
      o.addEventListener(
        ...
        function (t) {
          XPayStationWidget.init(e),
            setTimeout(function () {
              (i.buyButton.enabled = !0), XPayStationWidget.open();
            }, 100);
        },
        !1
      ),
  ...
  (Shop.prototype.onBuy = function (t) {
    this.getItemList(),
      "Offers" == this.currentTab
        ? (this.app.fire("Preview:Buy", !0), (this.shopType = "Offers"))
        : "Crates" == this.currentTab
        ? (this.app.fire("Preview:Open", t.item), (this.shopType = "Crates"))
        : "Buy VG" == this.currentTab && this.app.fire("Preview:Open", t.item),
  ...
  (Shop.prototype.onItemSelect = function (t) {
    ...
    for (var e = this.items.length; e--; )
      (this.items[e].element.opacity = 0.8),
  ...
  (Shop.prototype.showRarities = function (t) {
    ...
    for (var i in ((this.rarities = []), t)) {
      var o = t[i];
      o = o.toLowerCase();
      var n = this.raritiesItem.clone();
      (n.enabled = !0),
        (n.element.color = this[o + "Color"]),
        (n.findByName("Text").element.text =
          o.toUpperCase() + " (%" + this[o + "Percentage"] + ")"),
    ...
    (this.itemPriceEntity.element.text = t.price),
      ...
      "Crate" == t.type
        ? ((this.buyButton.enabled = !1),
          ...
          this.showRarities(t.rarity.split(", ")))
        : "VirtualCoin" == t.type
        ? ((this.unlockButton.enabled = !1),
          ...
          "" !== this.contentCreatorCode ||
            Utils.isMobile() ||
            (this.creatorCodeForm.enabled = !0),
        ...
        ? ((this.buyButton.enabled = !1),
          ...
          (this.equipButton.script.button.pressFunction =
            "Shop:Equip@" + t.item_id))
        : ((this.buyButton.enabled = !1),
          (this.equipButton.enabled = !1),
          "1" == t.is_showcase
            ? ((this.unlockButton.enabled = !1),
              (this.showcaseDisplay.enabled = !0))
            : ((this.unlockButton.enabled = !0),
              (this.showcaseDisplay.enabled = !1)));
  }),
  ...
  (Shop.prototype.addShopItem = function (t, e, i) {
    var o = !1,
      n = this.height;
    "VirtualCoin" == this.shopType
      ? ((o = this.smallItemEntity.clone()), (n = this.smallHeight))
      : (o = this.itemEntity.clone()),
      (o.enabled = !0),
    ...
    if (
      ("ScarSkin" == t.type && (r = "Scar-Thumbnail-White.png"),
...
Coins.attributes.add("coinEntity", {
  ...
  (Coins.prototype.createCoin = function () {
    var t = this.fallPoint.getPosition().clone(),
      i = 0.8 * Math.random() - 0.8 * Math.random(),
      n = 0.8 * Math.random(),
      e = 0.8 * Math.random() - 0.8 * Math.random(),
      s = 20 * Math.random(),
      a = 20 * Math.random(),
      y = 20 * Math.random(),
...
Objective.attributes.add("mode", {
  ...
  (Objective.prototype.initialize = function () {
    (this.distance = 100),
      ...
      (this.objectiveMaterial = this.app.assets.find(
        "Objective-Material"
      ).resource),
      this.nextCapture(),
      this.app.on("Game:Finish", this.onFinish, this),
  ...
  (Objective.prototype.nextCapture = function () {
    if (this.mode != pc.currentMode) return !1;
    (this.distance = this.playerEntity
      .getPosition()
      ...
      this.distance < this.radius
        ...
        : (this.app.fire("Objective:Inside", !1),
          ...
          this.objectiveMaterial.update()),
      (this.nextCaptureTimer = setTimeout(
        function (t) {
          t.nextCapture();
        },
        800,
...
Payload.attributes.add("startIndex", {
  ...
  (Payload.prototype.setNextNumber = function (t) {
    ...
    (this.index = Math.floor(t * this.points.length)),
      ...
      (this.bluePercentageEntity.element.text =
        Math.floor(100 * (1 - t)) + "%"),
  ...
  (Payload.prototype.update = function (t) {
    var e = this.entity
        .getPosition()
        .clone()
        .sub(this.nextPoint.clone())
        .length(),
      i = this.entity.getPosition().clone();
    this.lerpPoint = this.lerpPoint.lerp(
      this.lerpPoint,
      this.nextPoint,
      this.turnSpeed
    );
    var n = this.entity
        .getPosition()
        .lerp(i, this.lerpPoint, this.rotationSpeed),
...
Outline.attributes.add("color", {
  ...
  (Outline.prototype.initialize = function () {
    ...
    this.on("state", function (t) {
      ...
      this.on("destroy", function () {
        e.removeEffect(this.effect), t.outlineCamera.destroy();
      }),
      this.onSettingsChange();
  }),
  (Outline.prototype.onSettingsChange = function () {
    pc.settings &&
      !0 === pc.settings.disableSpecialEffects &&
      (this.entity.script.destroy("outline"),
  ...
  (Outline.prototype.onAdd = function (e, t) {
    if (e && e.model && -1 === e.model.layers.indexOf(this.outlineLayer.id)) {
      ...
      i.push(this.outlineLayer.id),
        ...
        t ||
          (clearTimeout(e.outlineTimeout),
          (e.outlineTimeout = setTimeout(
            function (e, t) {
              e.onRemove(t);
            },
            1500,
  ...
  (Outline.prototype.onRemove = function (e) {
    if (!(e && e.model && e.model.layers)) return !1;
    var t = e.model.layers.indexOf(this.outlineLayer.id);
    if (e && e.model && t > -1) {
      var i = e.model.layers.slice();
      i.splice(t, 1), (e.model.layers = i);
      var s = this.outlines.indexOf(e);
      s > -1 && this.outlines.splice(s, 1);
    }
  }),
  (Outline.prototype.onRestart = function () {
    for (var e = this.outlines.length; e--; ) this.onRemove(this.outlines[e]);
    this.outlines = [];
  }),
  (Outline.prototype.prepare = function () {
    (this.texture = new pc.Texture(this.app.graphicsDevice, {
      width: 0.5 * this.app.graphicsDevice.width,
      height: 0.5 * this.app.graphicsDevice.height,
      ...
      (this.outlineLayer = this.app.scene.layers.getLayerByName(
        "OutlineLayer"
      )),
      (this.outlineLayer.renderTarget = this.renderTarget),
      (this.effect = new pc.OutlineEffect(
        this.app.graphicsDevice,
        this.thickness
      )),
  ...
  (Outline.prototype.update = function (e) {
    this.entity != this.outlineCamera &&
...
River.attributes.add("material", {
  ...
  (River.prototype.update = function (e) {
    this.disabled ||
      ((this.material.resource.diffuseMapOffset.x =
        0.005 * Math.cos(pc.app._time / 500)),
      (this.material.resource.diffuseMapOffset.y =
        0.003 * Math.sin(pc.app._time / 200)),
...
(Settings.prototype.initialize = function () {
  ...
  (Settings.prototype.setSettings = function () {
    ...
    s > 0
      ? ((pc.settings.resolution = parseInt(s) / 100),
        (this.app.graphicsDevice.maxPixelRatio = 0.9 * pc.settings.resolution))
      : "undefined" != typeof mobileAds && pc.isMobile
      ? (this.app.graphicsDevice.maxPixelRatio = 1.5)
      : (this.app.graphicsDevice.maxPixelRatio = 0.95);
    var n = parseInt(this.getSetting("Volume"));
    n > -1
      ? ((pc.settings.volume = parseInt(n) / 100),
    ...
    (pc.settings.invertAxis = "true" === a),
      "true" === this.getSetting("DisableMenuMusic")
        ...
        : ((pc.settings.disableMenuMusic = !1),
...
TransformTool.attributes.add("cameraEntity", {
  ...
  (TransformTool.prototype.doRaycast = function () {
    var t = this.app.graphicsDevice.maxPixelRatio,
      ...
      e = this.cameraEntity.camera.screenToWorld(
        i,
        s,
        this.cameraEntity.camera.farClip
      ),
  ...
  (TransformTool.prototype.updateTransform = function (t) {
    ...
    "Translate" == this.mode &&
      ...
      "Z" == this.lockAxis &&
        (this.currentEntity.translate(0, 0, -i * t),
...
Digit.attributes.add("backgroundEntity", {
  ...
  (Digit.prototype.onDigitChange = function (t) {
    ...
    if (
      ...
      var n = this.app
        .tween(this.backgroundColor)
        .to(this.defaultBackgroundColor, 0.5, pc.Linear);
